        ...
        <div class="right-sidebar">
            <div class="slimscrollright">
                ...
                <ul id="themecolors" class="m-t-20">
                    ...
                    <li><a href="{{ secure_url('home/skin/default') }}" data-theme="default" class="default-theme working">1</a></li>
                    <li><a href="{{ secure_url('home/skin/green') }}" data-theme="green" class="green-theme">2</a></li>
                    <li><a href="{{ secure_url('home/skin/gray') }}" data-theme="gray" class="yellow-theme">3</a></li>
                    <li><a href="{{ secure_url('home/skin/blue') }}" data-theme="blue" class="blue-theme">4</a></li>
                    <li><a href="{{ secure_url('home/skin/purple') }}" data-theme="purple" class="purple-theme">5</a></li>
                    <li><a href="{{ secure_url('home/skin/megna') }}" data-theme="megna" class="megna-theme">6</a></li>
                    <li><b>With Dark sidebar</b></li>
                    <br/>
                    <li><a href="{{ secure_url('home/skin/default-dark') }}" data-theme="default-dark" class="default-dark-theme">7</a></li>
                    <li><a href="{{ secure_url('home/skin/green-dark') }}" data-theme="green-dark" class="green-dark-theme">8</a></li>
                    <li><a href="{{ secure_url('home/skin/gray-dark') }}" data-theme="gray-dark" class="yellow-dark-theme">9</a></li>
                    <li><a href="{{ secure_url('home/skin/blue-dark') }}" data-theme="blue-dark" class="blue-dark-theme">10</a></li>
                    <li><a href="{{ secure_url('home/skin/purple-dark') }}" data-theme="purple-dark" class="purple-dark-theme">11</a></li>
                    <li><a href="{{ secure_url('home/skin/megna-dark') }}" data-theme="megna-dark" class="megna-dark-theme">12</a></li>
                </ul>
...
jQuery(document).ready(function ($) {
  ...
  setInterval(function(){ 
   // var noteurl = $('.notif-value').attr('code'); 
    $.get('{{ secure_url("notification/load") }}',function(data){
