  ...
  <div class="container">   
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item " ><a href="{{ secure_url('') }}"> Home </a></li>
         <li class="breadcrumb-item " ><a href="{{ secure_url('posts') }}"> Posts </a></li>
         <li class="breadcrumb-item " ><a href="{{ secure_url('posts/category/'.$posts->category_alias ) }}"> {{ $posts->name }} </a></li>
        ...
        <div class="row">  
            <div class="col-md-8 ">
                ...
                <div class="blog-item-comments">
                    ...
                    <div class="content">
                        ...
                        <div class="tools">
                            ...
                            <a href="{{ secure_url('posts/remove/'.$posts->pageID.'/'. $posts->alias.'/'.$comm->commentID) }}" class="text-danger remove"><i class="fa fa-minus-circle"></i> Remove  </a>
                            @endif
                        </div>
                    </div> 
                </div>
                ...
                <div class="blog-item-comments">                   
                    ...
                    <div class="content">
                        <h4> Leave Comment </h4>
                         <form method="post"  action="{{ secure_url('posts/comment') }}" parsley-validate novalidate class="form">
                        {{ csrf_field() }}
