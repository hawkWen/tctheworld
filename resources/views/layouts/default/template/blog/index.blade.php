                    ...
                    <div class="row">
                        <div class="col-md-4">
                          <div class="blog-item-img">
                            <a href="{{ secure_url('posts/read/'.$post->alias) }}">
                        ...
                        <div class="col-md-8">  
                            ...
                            <div class="blog-item-text">
                                <h3 class="small-title"><a href="{{ secure_url('posts/read/'.$post->alias) }}">{{ $post->title }}</a></h3>
                                ...
                                <div class="blog-one-footer text-right">
                                    <a href="{{ secure_url('posts/read/'.$post->alias) }}">Read More   >> </a>             
                                </div>
                            </div>
                        </div>  
                    </div>    
