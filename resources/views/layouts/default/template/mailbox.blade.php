                                                ...
                                                <div class="modal-dialog" role="document">
                                                    ...
                                                    <div class="modal-content pr-2 pl-2">
                                                      <div class="modal-header">
                                                        ...
                                                        @else
                                                        <div class="modal-body m-0 p-0 text-dark mb-2">ทุกยอดฝาก 10% ทำยอด 2 เท่าถอนได้ไม่อั้น</div>
                                                        @endif
                ...
                <div class="item">
                    <div class="in">
                        ...
                        <div class="form-check form-switch  ms-2">
                            <input class="form-check-input dark-mode-switch" type="checkbox" id="darkmodeSwitch" data-toggle="modal" data-target="#addpromotion3per"  @if($user->bonus_mode==2) checked="checked" @endif>
                ...
                <div class="item">
                    <div class="in">
                        <div>
                            ...
                            <div class="text-light">
                           <img src="/images/diamond.png" width="18">    
                            </div>
                        </div>
