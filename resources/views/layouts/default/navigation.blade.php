                    ...
                    <li class="
                        ...
                        <a 
                            @if($menu2['menu_type'] =='external')
                                href="{{ secure_url($menu2['url'])}}" 
                            @else
                                href="{{ secure_url($menu2['module'])}}" 
                            @endif
     ...
     @if(config('sximo.cnf_multilang') ==1)
            <li class="menu-has-children ">
              ...
              <a href="#" >
               ...
               <ul >
                @foreach(SiteHelpers::langOption() as $lang)
                  <li><a href="{{ secure_url('home/lang/'.$lang['folder'])}}"><img class="flag-lang" src="{{ asset('sximo5/images/flags/'. $lang['folder'].'.png')}}" width="16" height="11" alt="lang"  /> {{  $lang['name'] }}</a></li>
                @endforeach 
              </ul>
