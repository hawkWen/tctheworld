            ...
            <div class="modal-content">
                <div class="modal-body p-0">
                    ...
                    <ul class="listview image-listview flush transparent no-line">
                        <li>
                            <a href="#" class="item">
                                <img src="{{ asset('img/sample/avatar/avatar2.jpg') }}" alt="image" class="image">
                                <div class="in">
                        ...
                        <li>
                            <a href="#" class="item">
                                <img src="{{ asset('img/sample/avatar/avatar4.jpg') }}" alt="image" class="image">
                                <div class="in">
                        ...
                        <li>
                            <a href="#" class="item">
                                <img src="{{ asset('img/sample/avatar/avatar3.jpg') }}" alt="image" class="image">
                                <div class="in">
