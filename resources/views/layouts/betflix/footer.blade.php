<button onclick="topFunction()" style="z-index: 55; width: 35px !important; height: 35px !important;" id="myBtn" class="back-to-top " title="Go to top">
   <span class="fa-stack" style="font-size: 6px; position: relative; top: -14px; right: 5px;">
      ...
      <script src="betflix/assets/js/jquery-3.1.0.min.js" type="text/javascript"></script>
      <script src="betflix/assets/js/popper.min.js"></script>
      <script src="betflix/assets/js/bootstrap.min.js"></script>
      <script src="betflix/assets/js/sweetalert.min.js"></script>
      <script>
      ...
      <script src="betflix/assets/js/preloader.js?v=0003"></script>
      <script>
      ...
      <script src="betflix/assets/js/filter_gridSelection.js"></script>
   </body>
</html>