      ...
      <!-- Changelog tab content -->
       <div class="tab-pane " id="control-sidebar-info-tab">
          <div class="text-center">
              ...
              <hr/>
              <div class="text-center">
                <a href="javascript:void(0)" onclick="SximoModal('{{ secure_url('core/template/changelog') }}','Sximo5 Changelog')"> All Changelogs </a> 
              </div>
      </div>   
      <!-- Home tab content -->
      ...
      <div class="tab-pane active" id="control-sidebar-settings-tab">
        <form method="post">
          ...
          <div class="form-group">
            ...
            <p>
             <a href="{{ secure_url('sximo/module')}}"> {{ Lang::get('core.dash_module') }} </a>
            </p>
          </div>
          <!-- /.form-group -->
          ...
          <div class="form-group">
            ...
            <p>
             <a href="{{ secure_url('sximo/config')}}"> {{ Lang::get('core.dash_setting') }} </a>
            </p>
          </div>
          <!-- /.form-group -->
          ...
          <div class="form-group">
            ...
            <p>
             <a href="{{ secure_url('sximo/menu')}}">  {{ Lang::get('core.dash_sitemenu') }} </a>
            </p>
          </div>
          <!-- /.form-group -->       
          ...
          <div class="form-group">
            ...
            <p>
             <a href="{{ secure_url('core/forms')}}">  {{ Lang::get('core.dash_formbuilder') }} </a>
            </p>
          </div>
          <!-- /.form-group -->
          ...
          <div class="form-group">
            ...
            <p>
               <a href="{{ secure_url('sximo/code')}}"> {{ Lang::get('core.dash_sourceeditor') }} </a> 
            </p>
          </div>
          <!-- /.form-group -->
          ...
          <div class="form-group">
            ...
            <p>
             <a href="{{ secure_url('sximo/tables')}}"> {{ Lang::get('core.dash_database') }} </a>
            </p>
          </div>
          <!-- /.form-group -->
          ...
          <div class="form-group">
            ...
            <p>
             <a href="{{ secure_url('sximo/rac')}}"> Manage Access to modules </a>
            </p>
          </div>
          <!-- /.form-group -->          
          ...
          <div class="form-group">
            <label class="control-sidebar-subheading">
             {{ Lang::get('core.dash_clearcache') }}
              <a href="{{ secure_url('sximo/config/clearlog') }}"  class="text-red pull-right clearCache"><i class="fa fa-trash-o"></i></a>
            </label>
          </div>
          <!-- /.form-group -->
        </form>
