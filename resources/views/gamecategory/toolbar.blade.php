	...
	<div class="row">
		<div class="col-md-4 text-left">
			<div class="input-group">
			      ...
			      <input type="text" class="form-control form-control-sm onsearch" data-target="{{ secure_url($pageModule) }}" data-div="{{ $pageModule }}" aria-label="..." placeholder=" Type And Hit Enter  ">
			    </div>
		</div>
		<div class="col-md-4"> 	
