...
@endif
		...
		{!! Form::open(array('url'=>'appstatus?return='.$return, 'class'=>'form-horizontal  sximo-form validated','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'appstatusFormAjax')) !!}
		...
		<div class="col-md-12">
						<fieldset><legend> appstatus</legend>
				{!! Form::hidden('id', $row['id']) !!}					
									  <div class="form-group row  " >
										<label for="Appname" class=" control-label col-md-4 "> Appname </label>
										<div class="col-md-8">
										  <input  type='text' name='appname' id='appname' value='{{ $row['appname'] }}' 
					...
					$status_opt = array( 'auto' => 'auto' ,  'manual' => 'manual' , ); ?>
