...
<div class="card">
	...
	{!! Form::open(array('url'=>'balancehistory?return='.$return, 'class'=>'form-horizontal  validated sximo-form','files' => true ,'id'=> 'FormTable' )) !!}
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ secure_url("balancehistory/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
