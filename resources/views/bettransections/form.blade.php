...
<div class="card">
	...
	{!! Form::open(array('url'=>'bettransections?return='.$return, 'class'=>'form-horizontal  validated sximo-form','files' => true ,'id'=> 'FormTable' )) !!}
	...
	<div class="">
		<div class="col-md-12">
						<fieldset><legend> bettransections</legend>
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ secure_url("bettransections/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
