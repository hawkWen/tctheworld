		 ...
		 {!! Form::open(array('url'=>'promotionauto', 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
...
<div class="col-md-12">
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$("#promotion_category_id").jCombo("{!! url('promotionauto/comboselect?filter=promotion_category:id:category_name') !!}",
