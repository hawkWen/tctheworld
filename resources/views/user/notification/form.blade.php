		...
		<div class="sbox-content">
			<div class="row">
				<div class="col-md-6 text-left" >
					<a href="{{ secure_url($pageModule.'?return='.$return) }}" class="tips btn btn-sm btn-default "  title="{{ __('core.btn_back') }}" ><i class="fa  fa-arrow-left"></i></a> 
				</div>
...
<div class="col-md-12">
			...
			<div style="clear:both"></div>	
				  ...
				  <div class="form-group">
					...
					<button type="button" onclick="location.href='{{ secure_url('notification?return='.$return) }}' " class="btn btn-danger  ">  {{ __('core.sb_cancel') }} </button>
					</div>	  
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ secure_url("notification/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
