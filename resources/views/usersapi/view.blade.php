		...
		<div class="toolbar-nav">
			<div class="row">
				...
				<div class="col-md-6 text-right " >
					<div class="btn-group">
						<a href="{{ ($prevnext['prev'] != '' ? secure_url('usersapi/'.$prevnext['prev'].'?return='.$return ) : '#') }}" class="tips btn btn-primary btn-sm" onclick="ajaxViewDetail('#usersapi',this.href); return false; "><i class="fa fa-arrow-left"></i>  </a>	
						<a href="{{ ($prevnext['next'] != '' ? secure_url('usersapi/'.$prevnext['next'].'?return='.$return ) : '#') }}" class="tips btn btn-primary  btn-sm " onclick="ajaxViewDetail('#usersapi',this.href); return false; "> <i class="fa fa-arrow-right"></i>  </a>
			   		</div>			
				</div>	
...
@endif	
		...
		<table class="table  table-bordered" >
			<tbody>	
					...
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('Hash', (isset($fields['hash']['language'])? $fields['hash']['language'] : array())) }}</td>
						<td>{{ $row->hash}} </td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('ยูสเซอร์', (isset($fields['username']['language'])? $fields['username']['language'] : array())) }}</td>
						<td>{{ $row->username}} </td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('รหัสผ่านเกม', (isset($fields['gamepassword']['language'])? $fields['gamepassword']['language'] : array())) }}</td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('ยูสเซอร์โบนัส', (isset($fields['bonususername']['language'])? $fields['bonususername']['language'] : array())) }}</td>
						<td>{{ $row->bonususername}} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('รหัสผ่านโบนัส', (isset($fields['bonuspassword']['language'])? $fields['bonuspassword']['language'] : array())) }}</td>
						<td>{{ $row->bonuspassword}} </td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('วันที่สมัคร', (isset($fields['created_at']['language'])? $fields['created_at']['language'] : array())) }}</td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('เงิน', (isset($fields['balance']['language'])? $fields['balance']['language'] : array())) }}</td>
						<td>{{ $row->balance}} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('เครดิตโบนัส', (isset($fields['bonus']['language'])? $fields['bonus']['language'] : array())) }}</td>
						<td>{{ $row->bonus}} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('Coins', (isset($fields['coins']['language'])? $fields['coins']['language'] : array())) }}</td>
						<td>{{ $row->coins}} </td>
					...
					<tr>
						...
						<td>{{ SiteHelpers::formatLookUp($row->ref,'ref','1:tb_users:id:username|first_name') }} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('Max Withdraw', (isset($fields['max_withdraw']['language'])? $fields['max_withdraw']['language'] : array())) }}</td>
						<td>{{ $row->max_withdraw}} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('Credits', (isset($fields['credits']['language'])? $fields['credits']['language'] : array())) }}</td>
						<td>{{ $row->credits}} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('รอบหมุนวงล้อ', (isset($fields['wheel_rounds']['language'])? $fields['wheel_rounds']['language'] : array())) }}</td>
						<td>{{ $row->wheel_rounds}} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('Ref Bonus', (isset($fields['ref_bonus']['language'])? $fields['ref_bonus']['language'] : array())) }}</td>
						<td>{{ $row->ref_bonus}} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('Bonus Mode', (isset($fields['bonus_mode']['language'])? $fields['bonus_mode']['language'] : array())) }}</td>
						<td>{{ $row->bonus_mode}} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('IP', (isset($fields['IP']['language'])? $fields['IP']['language'] : array())) }}</td>
						<td>{{ $row->IP}} </td>
