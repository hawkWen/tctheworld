...
<div class="page-titles">
  <h2> {{ $pageTitle }} <small> {{ $pageNote }} </small></h2>
	...
	<div class="toolbar-nav text-right">
		<a href="{{ secure_url($pageModule.'?return='.$return) }}" class="tips btn btn-sm  "  title="{{ __('core.btn_back') }}" ><i class="fa  fa-times"></i></a> 
		 ...
		 <div class="row">
			<div class="col-sm-9 ">
				...
				<div class="card mt-2">	
				  ...
				  <div class="form-group  " >
					<label for="ipt" class=" btn-primary  btn btn-sm">  {!! secure_url('')!!}/  </label>						 
		 	...
		 	<div class="col-sm-3 ">
			  ...
			  <div class="form-group">
				...
				<a href="{{ secure_url('cms/pages')}}" class="btn btn-info"> Close </a>
