	...
	<div class="card-body">
			...
			<div class="row">
				...
				<div class="col-md-8 text-right"> 	
					<div class="btn-group">
						 @if($access['is_add'] ==1)
						<a href="{{ secure_url('cms/pages/create?return='.$return) }}" class="btn btn-info btn-sm"  
						...
						<div class="btn-group">
					        ...
					        <ul class="dropdown-menu">
					         @if($access['is_excel'] ==1)
								<li class="nav-item"><a href="{{ secure_url( $pageModule .'/export?do=excel&return='.$return) }}" class="tips nav-link"> Export CSV </a></li>	
							@endif
							@if($access['is_add'] ==1)
								<li class="nav-item"><a href="{{ secure_url($pageModule .'/import?return='.$return) }}"  class=" nav-link" onclick="SximoModal(this.href, 'Import CSV'); return false;"> Import CSV</a></li>
						 ...
						 <td>
							 	...
							 	<div class="dropdown">
								  ...
								  <ul class="dropdown-menu">
									...
									<li class="nav-item"><a href="{{ secure_url($row->alias)}}" target="_blank" class="nav-link tips nav-link" title="{{ __('core.btn_view') }}"> {{ __('core.btn_view') }} </a></li>
									@endif
									@if($access['is_edit'] ==1)
									<li class="nav-item"><a  href="{{ secure_url('cms/pages/'.$row->pageID.'/edit?return='.$return) }}" class="nav-link tips nav-link" title="{{ __('core.btn_edit') }}"> {{ __('core.btn_edit') }} </a></li>
									@endif
