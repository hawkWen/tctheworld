		...
		<div class="toolbar-nav">
			<div class="row">
				...
				<div class="col-md-8 text-right"> 	
					<div class="btn-group">
						@if($access['is_add'] ==1)
						<a href="{{ secure_url('core/groups/create?return='.$return) }}" class="btn  btn-sm btn-info"  
						...
						<div class="btn-group">
					        ...
					        <ul class="dropdown-menu">
								...
								<li  class="nav-item"><a href="{{ secure_url($pageModule) }}"  class="nav-link tips" > Clear Search </a></li>
		                ...
		                <tr>
						 ...
						 <td>
							 	...
							 	<div class="dropdown">
								  ...
								  <ul class="dropdown-menu">									
									@if($access['is_edit'] ==1)
									<li class="nav-item"><a  href="{{ secure_url('core/groups/'.$row->group_id.'/edit?return='.$return) }}" class="nav-link tips" title="{{ __('core.btn_edit') }}"> {{ __('core.btn_edit') }} </a></li>
									@endif
									@if($access['is_remove'] ==1)
