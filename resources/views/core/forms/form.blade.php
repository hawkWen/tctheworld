		...
		<div class="sbox">
			<div class="sbox-title">
				...
				<div class="sbox-tools" >
					<a href="{{ secure_url($pageModule.'?return='.$return) }}" class="tips btn btn-xs "  title="{{ Lang::get('core.btn_back') }}" ><i class="fa  fa-times"></i></a> 
				</div>	
			</div>
...
<div class="col-md-3">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="{{ secure_url('dashboard') }}"> Home</a></li>
        <li><a href="{{ secure_url('core/forms') }}"> Form Generator</a></li>
...
<div class="box box-primary">
	<div class="box-header with-border">
		<div class="box-header-tools pull-left" >
			<a href="{{ secure_url($pageModule.'?return='.$return) }}" class="tips btn btn-sm btn-info btn-circle"  title="{{ Lang::get('core.btn_back') }}" ><i class="fa  fa-arrow-left"></i></a> 
			<a class="btn btn-xs btn-warning tips btn-circle" title="Documentation" href="{{ secure_url('core/forms/docs') }}" onclick="SximoModal(this.href,'Documentation'); return false;"><i class="fa fa-book"></i></a>
		</div>
...
<style type="text/css">
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		//$('#formConfig').get('{{ secure_url("forms/configuration/".$row["formID"]) }}');
		<?php if($row['formID'] !='') { ?>
		$.get( '{{ secure_url("core/forms/configuration?id=".$row["formID"]) }}', function( data ) {
