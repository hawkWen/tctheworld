		...
		<div class="col-md-6">
			<fieldset>
				<legend> Account Credit </legend>
				  ...
				  @endif			
				   <div class="form-group  " >
					<label for="Email" class=" control-label "> Username <span class="asterix"> * </span></label>
					<div class="">
					  {!! Form::text('username', $row['username'],array('class'=>'form-control  form-control-sm', 'placeholder'=>'', 'required'=>'true','readonly'=>'true'  )) !!} 
					 </div> 
