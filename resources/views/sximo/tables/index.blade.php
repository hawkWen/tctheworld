...
<div class="page-titles">
  <h2><i class="fas fa-database"></i> {{ $pageTitle }} <small> {{ $pageNote }} </small></h2>
	...
	<div class="toolbar-nav">
      	<div class="btn-group">
      		<a href="{{ secure_url('sximo/tables/tableconfig/')}}" class="btn btn-sm btn-info  linkConfig tips" title="New Table "><i class="fa fa-plus"></i> Create New Table  </a>
			<a href="{{ secure_url('sximo/tables/mysqleditor/')}}" class="btn btn-sm  btn-primary linkConfig tips" title="MySQL Editor"><i class="fa fa-pencil"></i> MySQL Editor  </a>	
	    </div>
	</div>
				...
				<div class="table-database">
					<div class="list-group">				 
					  @foreach($tables as $table)
					  	<a href="{{ secure_url('sximo/tables/tableconfig/'.$table)}}" class="list-group-item list-group-item-action linkConfig">  
