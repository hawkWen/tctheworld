...
<ul class="nav nav-tabs" style="margin-bottom:10px;">
    <li class="nav-item" ><a class="nav-link " href="{{ secure_url('sximo/module/form/'.$module_name)}}">Form Configuration </a></li>
    <li class="nav-item" ><a class="nav-link " href="{{ secure_url('sximo/module/subform/'.$module_name)}}">Sub Form </a></li> 
  <li class="nav-item"><a class="nav-link active" href="{{ secure_url('sximo/module/formdesign/'.$module_name)}}">Form Layout</a></li> 
