  ...
  <li class="nav-item"><a class="nav-link" href="{{ URL::to('sximo/module/formdesign/'.$module_name)}}">Form Layout</a></li> 
    ...
    {!! Form::open(array('url'=>'sximo/module/savesubform/'.$module_name, 'class'=>'form-horizontal  ','id'=>'fSubf')) !!}
        ...
        <div class="col-md-8">
          ...
          <a href="{{ secure_url('sximo/module/subformremove/'.$module_name) }}" class="btn btn-danger"><i class="icon-cancel-circle2 "></i> Remove </a>
          @endif
         </div> 
        </div> 
...
$(document).ready(function(){   
    $("#table").jCombo("{{ secure_url('sximo/module/combotable') }}",
    {selected_value : "{{ (isset($subform['table']) ? $subform['table']: null ) }}" }); 
    $("#key").jCombo("{{ secure_url('sximo/module/combotablefield') }}?table=",
