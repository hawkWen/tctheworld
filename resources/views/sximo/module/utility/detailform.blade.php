        ...
        <tbody>
			...
			<tr>
				...
				<td >
					...
					onclick="ajaxInlineSave('#{{ $pageModule }}','{{secure_url($pageModule.'/quicksave') }}','{{secure_url($pageModule.'/detailview/form?md='.$filtermd) }}')">
					...
					<td width="50"> <?php echo $n;?>  </td>
					 ...
					 <?php foreach ($tableGrid as $field) :
					  ...
					  <td>
					  	...
					  	<a href="javascript:void(0)" onclick="ajaxInlineRemove('#{{ $pageModule }}-{{$n}}','{{secure_url($pageModule."/removerow/".$row->$primarykey) }}')" class=" quickRemove btn btn-sm btn-danger" ><i class="fa fa-minus"></i></a>
					  	<?php endif; ?>
					  </td>			 
                </tr>
