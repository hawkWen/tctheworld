  ...
  <div class="row">
    <div class="col-md-8">
      <div class="btn-group">
          ...
          <a href="javascript:;"  onclick="SximoConfirmDelete('{{ secure_url('sximo/module/destroy/'.$row->module_id)}}')" class="btn  btn-sm btn-danger"> Delete </a>
          @endif

          <a href="{{ secure_url( $module_name )}}" class="btn  btn-sm btn-primary" target="_blank">  Preview  </a>
          <a href="{{ secure_url('sximo/module')}}" class="btn  btn-sm btn-info">  Close </a>
...
<script type="text/javascript">
  function jumpTo( val ) {
      window.location.href='<?php echo secure_url("sximo/module/".Request::segment(3)) ?>/'+ val
  }
</script>