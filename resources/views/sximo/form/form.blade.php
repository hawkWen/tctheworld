...
<a href="{{ secure_url('root/form/field') }}" onclick="SximoModal(this.href,'Input Field'); return false;" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Save Form Info </a>
