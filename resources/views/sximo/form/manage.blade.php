			...
			<td>
				<div class="input-group">
					<div class="input-group-btn ">
						<a href="{{ secure_url('sximo/form/field')}}" class="btn btn-sm btn-default" onclick="SximoModal(this.href,'Field Configuration'); return false;"> <i class="fa fa-question-circle"></i></a>
					</div>	
...
@if($row->formID !='')
<a href="{{ secure_url('sximo/form/preview?id='.$row->formID) }}" class="btn btn-success btn-sm" onclick="SximoModal(this.href,'Form Preview'); return false;"> Preview Form </a>

<a href="{{ secure_url('sximo/form/remove?id='.$row->formID) }}" class="btn btn-danger btn-sm remove"> Delete This Form </a>
@endif
