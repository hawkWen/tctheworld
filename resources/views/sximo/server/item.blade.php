			...
			<div class="card">
				...
				<div class="card-body">
					...
					<div class="row">
						...
						onclick="SximoModal('{{ secure_url("sximo/server/install?id=".$row->ProductID."&t=".$row->ScriptType) }}' ,'Download & Install' ); return false;" class="btn btn-sm btn-primary "> Install </a>
							</div>
						</div>
					</div>	
