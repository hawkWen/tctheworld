...
<div class="col-md-12">
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$("#apiuser").jCombo("{!! secure_url('sximo/rac/comboselect?filter=tb_users:id:email') !!}",
		{  selected_value : '{{ $row["apiuser"] }}' });
		
		$("#modules").jCombo("{!! secure_url('sximo/rac/comboselect?filter=tb_module:module_name:module_title&limit=WHERE:module_type:!=:core') !!}",
