...
@endif
		...
		{!! Form::open(array('url'=>'promotioncate?return='.$return, 'class'=>'form-horizontal  sximo-form validated','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'promotioncateFormAjax')) !!}
		...
		<div class="col-md-12">
						<fieldset><legend> Promotion category</legend>
				{!! Form::hidden('id', $row['id']) !!}					
									  <div class="form-group row  " >
										<label for="Category Name" class=" control-label col-md-4 "> Category Name </label>
										<div class="col-md-8">
						     ...
						     class='form-control form-control-sm ' /> 
									  ...
									  <div class="form-group row  " >
										<label for="Category Desc" class=" control-label col-md-4 "> Category Desc </label>
										<div class="col-md-8">
										  <input  type='text' name='category_desc' id='category_desc' value='{{ $row['category_desc'] }}' 
						     class='form-control form-control-sm ' /> 
										 </div> 
...
$(document).ready(function() { 
	...
	var form = $('#promotioncateFormAjax'); 
	form.parsley();
