...
@endif
		...
		{!! Form::open(array('url'=>'gamehistories?return='.$return, 'class'=>'form-horizontal  sximo-form validated','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'gamehistoriesFormAjax')) !!}
...
$(document).ready(function() { 
	...
	var form = $('#gamehistoriesFormAjax'); 
	form.parsley();
