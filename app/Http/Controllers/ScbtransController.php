...
use App\Models\Scbtrans;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class ScbtransController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'scbtrans';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Scbtrans();	
	...
	public static function display(  )
	{
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('scbtrans.public.view',$data);			
			}			
		} 
		else {
			...
			return view('scbtrans.public.index',$data);	
		}
