...
use App\Models\Kbanktrans;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class KbanktransController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'kbanktrans';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Kbanktrans();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'kbanktrans',
	...
	public static function display(  )
	{
		...
		$model  = new Kbanktrans();
		$info = $model::makeInfo('kbanktrans');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('kbanktrans.public.view',$data);			
			}			
		} 
		else {
			...
			return view('kbanktrans.public.index',$data);	
		}
