...
use App\Models\Transachistories;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class TransachistoriesController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'transachistories';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Transachistories();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'transachistories',
	...
	public static function display(  )
	{
		...
		$model  = new Transachistories();
		$info = $model::makeInfo('transachistories');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('transachistories.public.view',$data);			
			}			
		} 
		else {
			...
			return view('transachistories.public.index',$data);	
		}
