...
class SitesettingController extends Controller {
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('sitesetting');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('sitesetting.public.view',$data);			
			}			
		} 
		else {
			...
			return view('sitesetting.public.index',$data);	
		}
