...
use App\Models\Bettransections;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class BettransectionsController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'bettransections';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Bettransections();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'bettransections',
	...
	public static function display(  )
	{
		...
		$model  = new Bettransections();
		$info = $model::makeInfo('bettransections');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('bettransections.public.view',$data);			
			}			
		} 
		else {
			...
			return view('bettransections.public.index',$data);	
		}
