...
class AccesstokenController extends Controller {
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('accesstoken');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('accesstoken.public.view',$data);			
			}			
		} 
		else {
			...
			return view('accesstoken.public.index',$data);	
		}
