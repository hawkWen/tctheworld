...
use App\Models\Gamepartners;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 

class GamepartnersController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'gamepartners';
	static $per_page	= '10';
	
	public function __construct() 
	{
		parent::__construct();
		$this->model = new Gamepartners();
		...
		$this->data = array(
			...
			'pageModule'		=> 'gamepartners',
			'pageUrl'			=>  secure_url('gamepartners'),
