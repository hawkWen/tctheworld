...
use App\Models\Promotionauto;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class PromotionautoController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'promotionauto';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Promotionauto();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'promotionauto',
	...
	public static function display(  )
	{
		...
		$model  = new Promotionauto();
		$info = $model::makeInfo('promotionauto');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('promotionauto.public.view',$data);			
			}			
		} 
		else {
			...
			return view('promotionauto.public.index',$data);	
		}
