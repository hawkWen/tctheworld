...
use App\Models\Lastgamehistory;
use App\Library\DataHelpers;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 

class LastgamehistoryController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'lastgamehistory';
	static $per_page	= '10';
	
	public function __construct() 
	{
		parent::__construct();
		$this->model = new Lastgamehistory();
		...
		$this->data = array(
			...
			'pageModule'		=> 'lastgamehistory',
			'pageUrl'			=>  secure_url('lastgamehistory'),
	...
	public function index()
	{
		...
		$this->data['setting'] 		= $this->info['setting'];
		return view('lastgamehistory.index',$this->data);
	}
