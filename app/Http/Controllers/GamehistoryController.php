...
class GamehistoryController extends Controller {
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('gamehistory');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('gamehistory.public.view',$data);			
			}			
		} 
		else {
			...
			return view('gamehistory.public.index',$data);	
		}
