...
use App\Models\Promotioncate;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 

class PromotioncateController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'promotioncate';
	static $per_page	= '10';
	
	public function __construct() 
	{
		parent::__construct();
		$this->model = new Promotioncate();
		...
		$this->data = array(
			...
			'pageModule'		=> 'promotioncate',
			'pageUrl'			=>  url('promotioncate'),
