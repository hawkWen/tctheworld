...
use App\Models\Truewallettrans;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class TruewallettransController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'truewallettrans';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Truewallettrans();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'truewallettrans',
	...
	public static function display(  )
	{
		...
		$model  = new Truewallettrans();
		$info = $model::makeInfo('truewallettrans');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('truewallettrans.public.view',$data);			
			}			
		} 
		else {
			...
			return view('truewallettrans.public.index',$data);	
		}
