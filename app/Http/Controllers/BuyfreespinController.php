...
use App\Models\Buyfreespin;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 

class BuyfreespinController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'buyfreespin';
	static $per_page	= '10';
	
	public function __construct() 
	{
		parent::__construct();
		$this->model = new Buyfreespin();
		...
		$this->data = array(
			...
			'pageModule'		=> 'buyfreespin',
			'pageUrl'			=>  url('buyfreespin'),
