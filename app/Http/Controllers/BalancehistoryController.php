...
class BalancehistoryController extends Controller {
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('balancehistory');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('balancehistory.public.view',$data);			
			}			
		} 
		else {
			...
			return view('balancehistory.public.index',$data);	
		}
