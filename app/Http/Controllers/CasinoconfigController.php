...
use App\Models\Casinoconfig;
use App\Library\DataHelpers;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 

class CasinoconfigController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'casinoconfig';
	static $per_page	= '10';
	
	public function __construct() 
	{
		parent::__construct();
		$this->model = new Casinoconfig();
		...
		$this->data = array(
			...
			'pageModule'		=> 'casinoconfig',
			'pageUrl'			=>  url('casinoconfig'),
	...
	public function index()
	{
		...
		$this->data['setting'] 		= $this->info['setting'];
		return view('casinoconfig.index',$this->data);
	}
