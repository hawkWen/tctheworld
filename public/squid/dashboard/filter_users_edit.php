...
if ($_SERVER['REQUEST_METHOD'] == 'POST') 
{
    ...
    if($stat)
    {
        $_SESSION['success'] = "User <strong>".$details['email']."</strong> updated successfully!";
        header('location: filter_users.php');
        exit();
    }
}
...
<main>
	<div class="container-fluid">
		<h1 class="mt-4">Edit User Filter</h1>
		<ol class="breadcrumb mb-4">
			<li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
			<li class="breadcrumb-item"><a href="filter_users.php">Filter Users</a></li>
			<li class="breadcrumb-item active">Edit User Filter</li>
		</ol>
