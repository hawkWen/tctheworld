        ...
        $('#dataTable').dataTable({
            ...
            columns: [{ data: null, sortable:false, render: function ( data, type, row ) {
                ...
                },
                {
                    ...
                    sortable:false,
                    render: function(data, type, row) {
                        var goodSpanHTML = '<h5 style="display:inline;"><span class="badge badge-success">Valid</span></h5>';
                        var userSpanHTML = '';
                        var scoreSpanHTML = '';

                        if(data.filter_user != ''){
                            goodSpanHTML = '';
                            userSpanHTML = '<h5 style="display:inline;"><span class="badge badge-danger">Spam</span></h5> ';
                        }
                ...
                },
                {
                    data: "date"
                }, <?php if ($_SESSION['admin_type'] == 'super') { ?>
					  {
                        ...
                        sortable: false,
                        render: function(data, type, row) {
                            var editButtonHTML = '<a class="btn btn-primary btn-sm" href="scoreboard_edit.php?score_id=' + data.id + '&operation=edit"><span class="fa fa-edit fa-fw"></span> Edit</a> ';
                            var removeButtonHTML = '<a class="btn btn-danger btn-sm" href="" data-toggle="modal" data-target="#confirm-delete-' + data.id + '"><span class="fa fa-trash-alt fa-fw"></span> Remove</a>';
                            var removePopHTML = populateModal('delete', data.id, 'scoreboard_delete.php', 'Are you sure you want to delete this score?', data.email);
                            var filterButtonHTML = ' <a class="btn btn-danger btn-sm" href="" data-toggle="modal" data-target="#confirm-filter-' + data.id + '"><span class="fa fa-filter fa-fw"></span> Spam</a>';
                            var filterPopHTML = populateModal('filter', data.id, 'scoreboard_filter.php', 'Are you sure you want to filter this user?', data.email);
		   ...
		   initComplete: function () {			   
			    this.api().columns([5]).every( function () {
					var column = this;
					var select = $('<select class="form-control form-control-sm" style="width:150px;"><option value="">All time</option></select>')
					...
					select.append( '<option value="daily">Daily</option>' )
					select.append( '<option value="weekly">Weekly</option>' )
					select.append( '<option value="monthly">Monthly</option>' )
				});
            }
        });
                ...
                },
				{
                    data: "date"
                }, <?php if ($_SESSION['admin_type'] == 'super') { ?>
					  {
                        ...
                        sortable: false,
                        render: function(data, type, row) {
                            var editButtonHTML = '<a class="btn btn-primary btn-sm" href="filter_users_edit.php?user_id=' + data.id + '&operation=edit"><span class="fa fa-edit fa-fw"></span> Edit</a> ';
                            var removeButtonHTML = '<a class="btn btn-danger btn-sm" href="" data-toggle="modal" data-target="#confirm-delete-' + data.id + '"><span class="fa fa-trash-alt fa-fw"></span> Remove</a>';
                            var removePopHTML = populateModal('delete', data.id, 'filter_users_delete.php', 'Are you sure you want to delete this filter?', data.email);
                ...
                },
				{
                    data: "date"
                }, <?php if ($_SESSION['admin_type'] == 'super') { ?>
					  {
                        ...
                        sortable: false,
                        render: function(data, type, row) {
                            var editButtonHTML = '<a class="btn btn-primary btn-sm" href="filter_scores_edit.php?score_id=' + data.id + '&operation=edit"><span class="fa fa-edit fa-fw"></span> Edit</a> ';
                            var removeButtonHTML = '<a class="btn btn-danger btn-sm" href="" data-toggle="modal" data-target="#confirm-delete-' + data.id + '"><span class="fa fa-trash-alt fa-fw"></span> Remove</a>';
                            var removePopHTML = populateModal('delete', data.id, 'filter_scores_delete.php', 'Are you sure you want to delete this filter?', data.email);
	   ...
	   $('#dataTable').dataTable({
		   ...
		   columns: [
				...
				{ data: null, sortable:false, render: function ( data, type, row ) {
					var editButtonHTML = '<a class="btn btn-primary btn-sm" href="admin_users_edit.php?admin_user_id='+data.id+'&operation=edit"><span class="fa fa-edit fa-fw"></span> Edit</a> ';
					var removeButtonHTML = '<a class="btn btn-danger btn-sm" href="" data-toggle="modal" data-target="#confirm-delete-'+data.id+'"><span class="fa fa-trash-alt fa-fw"></span> Remove</a>';
					var removePopHTML = populateModal('delete',data.id,'admin_users_delete.php','Are you sure you want to delete this admin account?',data.user_name);
