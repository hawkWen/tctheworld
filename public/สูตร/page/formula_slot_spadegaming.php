...
<script language="JavaScript">
     ...
     function doCallAjax(Sort) {
      ...
      var url = '<?php echo $web_url; ?>/encryption/api_slot.php?g=spadegaming';
...
$(document).ready(function(){
 ...
 $('#search').keyup(function(){
  ...
  $.getJSON('<?php echo $web_url; ?>/encryption/api_slot.php?g=spadegaming_seach', function(data) {
