...
<script language="JavaScript">
     ...
     function doCallAjax(Sort) {
      ...
      var url = '<?php echo $web_url; ?>/encryption/api_slot.php?g=iconic-gaming';
...
$(document).ready(function(){
 ...
 $('#search').keyup(function(){
  ...
  $.getJSON('<?php echo $web_url; ?>/encryption/api_slot.php?g=iconic-gaming_seach', function(data) {
